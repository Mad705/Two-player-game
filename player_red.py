...
class Game:
    ...
    def __init__(self, w, h):
        ...
        self.width = w
        self.height = h
        self.player2 = Player(50, 50,(0,255,255))
        self.player = Player(450,450,(255,102,102))
    ...
    def run(self):
        ...
        while run:
            ...
            # Draw points
            self.canvas.draw_text("Blue player points: " + str(self.points[1]), 20, 10, 10)
            self.canvas.draw_text("Red player points: " + str(self.points[0]), 20, 10, 30)
